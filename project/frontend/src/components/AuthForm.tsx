...
export const AuthForm: React.FC = () => {
  ...
  const handleGoogleLogin = () => {
    // Redirect directly to backend's Google auth endpoint
        ...
        <AnimatePresence mode="wait">
          {mode === 'verify' ? (
            ...
            >
              ...
              <button
                type="button"
                className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-white border border-gray-200 text-gray-700 font-semibold shadow hover:bg-gray-50 transition"
                onClick={handleGoogleLogin}  // Change from loginWithGoogle to handleGoogleLogin
                disabled={isLoading}
              >
